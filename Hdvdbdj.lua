-- ============================================================
--           BIBIZZZAN HUB  v7.0  (FINAL ULTIMATE)
...
local Settings = {
    ...
    SilentAimRadius = 30,
    WalkSpeed = 16,
    Esp = false,          -- одна кнопка включает всё: имя+здоровье, линии, бокс
}
...
-- ============================================================
--  КНОПКА ОТКРЫТИЯ (перемещаемая, открывает меню)
-- ============================================================
...
-- ============================================================
--  ФУНКЦИИ ДЛЯ СОЗДАНИЯ ЭЛЕМЕНТОВ (ON/OFF кнопки)
-- ============================================================
...
-- ============================================================
--  ЗАПОЛНЯЕМ ВКЛАДКУ MAIN (кнопки ON/OFF + ползунки)
-- ============================================================
local yMain = 5
