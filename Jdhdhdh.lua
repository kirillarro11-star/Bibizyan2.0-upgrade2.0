-- ============================================================
--           BIBIZZZAN HUB  v5.0  (FINAL ULTIMATE)
...
local function applyCharacter(char)
    ...
    -- Infinity Jump (возможность прыгать в воздухе)
    local infJumpConn
...
print("✅ BIBIZZZAN HUB v5.0 загружен! Нажмите кнопку для открытия.")
